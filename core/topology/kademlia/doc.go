...
For the rationale behind this please refer to the appropriate chapters in the book of flock.
...
in an ever-increasing size of Flock, resulting in smaller areas of responsibility
for the nodes, maintaining a general upper bound of the assigned nominal
area of responsibility in terms of actual storage requirement. See book of Flock for more details.
