...
// Item holds fields relevant to Cluster Chunk data and metadata.
// All information required for cluster storage and operations
// on that storage must be defined here.
// This structure is logically connected to cluster storage,
