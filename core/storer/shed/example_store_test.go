...
import (
	...
	"github.com/redesblock/mop/core/storer/storage/testing"
...
func (s *Store) Put(_ context.Context, ch cluster.Chunk) (err error) {
...
// are changed.
func (s *Store) Get(_ context.Context, addr cluster.Address) (c cluster.Chunk, err error) {
	...
	// Return the chunk.
	return cluster.NewChunk(cluster.NewAddress(item.Address), item.Data), nil
}
