...
var (
	...
	fileLengths     = []int{
		...
		65,                             // 5
		cluster.ChunkSize,              // 6
		cluster.ChunkSize + 31,         // 7
		cluster.ChunkSize + 32,         // 8
		cluster.ChunkSize + 63,         // 9
		cluster.ChunkSize + 64,         // 10
		cluster.ChunkSize * 2,          // 11
		cluster.ChunkSize*2 + 32,       // 12
		cluster.ChunkSize * 128,        // 13
		cluster.ChunkSize*128 + 31,     // 14
		cluster.ChunkSize*128 + 32,     // 15
		cluster.ChunkSize*128 + 64,     // 16
		cluster.ChunkSize * 129,        // 17
		cluster.ChunkSize * 130,        // 18
		cluster.ChunkSize * 128 * 128,  // 19
		cluster.ChunkSize*128*128 + 32, // 20
	}
...
func GetVector(t *testing.T, idx int) ([]byte, cluster.Address) {
	t.Helper()
	...
	return data, cluster.MustParseHexAddress(fileExpectHashHex[idx])
}
