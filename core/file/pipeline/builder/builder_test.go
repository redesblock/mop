...
func TestPartialWrites(t *testing.T) {
	...
	exp := cluster.MustParseHexAddress("92672a471f4419b255d7cb0cf313474a6f5856fb347c5ece85fb706d644b630f")
...
func TestEmpty(t *testing.T) {
	...
	exp := cluster.MustParseHexAddress("b34ca8c22b9e982354f9c7f50b470d66db428d880c8a904d5fe4ec9713171526")
	if !bytes.Equal(exp.Bytes(), sum) {
		t.Fatalf("expected %s got %s", exp.String(), hex.EncodeToString(sum))
	}
}
...
goos: linux
goarch: amd64
core: github.com/redesblock/mop/core/file/pipeline/builder
BenchmarkPipeline
