...
func TestPretty(t *testing.T) {
	...
	testCases := []struct {
		...
		exp: `"<panic: value method github.com/redesblock/mop/core/log.marshalerTest.MarshalLog called using nil *marshalerTest pointer>"`,
	}, {
		...
		exp: `"<panic: value method github.com/redesblock/mop/core/log.stringerTest.String called using nil *stringerTest pointer>"`,
	}, {
		...
		val: (*errorTest)(nil),
		exp: `"<panic: value method github.com/redesblock/mop/core/log.errorTest.Error called using nil *errorTest pointer>"`,
	}, {
