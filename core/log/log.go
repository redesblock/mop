...
// Level is treated as a chainsync/atomic int32.
type Level int32
...
// WithSink tells the logger to log to the given chainsync.
// The provided chainsync should be safe for concurrent use,
