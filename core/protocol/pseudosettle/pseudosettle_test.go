...
import (
	...
	"github.com/redesblock/mop/core/protocol/pseudosettle/pb"
...
func (t *testObserver) setPeerDebt(peer cluster.Address, debt *big.Int) {
...
func (t *testObserver) Reserve(ctx context.Context, peer cluster.Address, amount uint64) error {
	return nil
}

func (t *testObserver) Release(peer cluster.Address, amount uint64) {
}

var testRefreshRate = int64(10000)
var testRefreshRateLight = int64(1000)

func testCaseNotAccepted(t *testing.T, recorder *streamtest.Recorder, payerObserver, receiverObserver *testObserver, payer, recipient *pseudosettle.Service, peerID cluster.Address, payerTime, recipientTime int64, recordsLength int, debtAmount, amount *big.Int, expectedError error) {
...
func testCaseAccepted(t *testing.T, recorder *streamtest.Recorder, payerObserver, receiverObserver *testObserver, payer, recipient *pseudosettle.Service, peerID cluster.Address, payerTime, recipientTime int64, recordsLength, msgLength, recMsgLength int, debtAmount, amount, accepted, totalAmount *big.Int) {

	payer.SetTime(payerTime)
	recipient.SetTime(recipientTime)

	// set debt shown by bookkeeper (observer)
	receiverObserver.setPeerDebt(peerID, debtAmount)
...
func TestPayment(t *testing.T) {
	...
	peerID := cluster.MustParseHexAddress("9ee7add7")
