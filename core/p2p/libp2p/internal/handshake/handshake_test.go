...
func TestHandshake(t *testing.T) {
	...
	node1BzzAddress, err := mop.NewAddress(signer1, node1ma, addr, networkID, nonce)
	if err != nil {
		t.Fatal(err)
	}
	...
	node2BzzAddress, err := mop.NewAddress(signer2, node2ma, addr2, networkID, nonce)
	if err != nil {
		t.Fatal(err)
	}
