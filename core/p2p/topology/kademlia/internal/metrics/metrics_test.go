...
import (
	...
	"github.com/redesblock/mop/core/p2p/topology/kademlia/internal/metrics"
	"github.com/redesblock/mop/core/storer/shed"
)

func snapshot(t *testing.T, mc *metrics.Collector, sst time.Time, addr cluster.Address) *metrics.Snapshot {
	t.Helper()
...
func TestPeerMetricsCollector(t *testing.T) {
	...
	var (
		addr = cluster.MustParseHexAddress("0123456789")
