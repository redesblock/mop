...
type AddrTuple struct {
	Addr cluster.Address // the peer address
	PO   uint8           // the po
}
...
func (m *Mock) AddPeers(addr ...cluster.Address) {
	panic("not implemented") // TODO: Implement
}

func (m *Mock) ClosestPeer(addr cluster.Address, _ bool, _ topology.Filter, skipPeers ...cluster.Address) (peerAddr cluster.Address, err error) {
	panic("not implemented") // TODO: Implement
}

func (m *Mock) IsWithinDepth(adr cluster.Address) bool {
	panic("not implemented") // TODO: Implement
}
...
func (m *Mock) Announce(_ context.Context, _ cluster.Address, _ bool) error {
	return nil
}

func (m *Mock) AnnounceTo(_ context.Context, _, _ cluster.Address, _ bool) error {
	return nil
}
