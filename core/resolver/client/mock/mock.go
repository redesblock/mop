...
type Client struct {
	isConnected    bool
	endpoint       string
	defaultAddress cluster.Address
	resolveFn      func(string) (cluster.Address, error)
}
...
func WitResolveAddress(addr cluster.Address) Option {
	return func(cl *Client) {
...
func WithResolveFunc(fn func(string) (cluster.Address, error)) Option {
	return func(cl *Client) {
		cl.resolveFn = fn
	}
}
...
func (cl *Client) Resolve(name string) (cluster.Address, error) {
	if cl.resolveFn == nil {
