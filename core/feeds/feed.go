...
func NewUpdate(f *Feed, idx Index, timestamp int64, payload, sig []byte) (cluster.Chunk, error) {
...
func (u *Update) Address() (cluster.Address, error) {
	var addr cluster.Address
	i, err := u.Id()
	if err != nil {
		return addr, err
	}
