...
type Lookup interface {
	At(ctx context.Context, at, after int64) (chunk cluster.Chunk, currentIndex, nextIndex Index, err error)
}
...
func Latest(ctx context.Context, l Lookup, after int64) (cluster.Chunk, error) {
...
func (f *Getter) Get(ctx context.Context, i Index) (cluster.Chunk, error) {
...
func FromChunk(ch cluster.Chunk) (uint64, []byte, error) {
...
func UpdatedAt(ch cluster.Chunk) (uint64, error) {
	d := ch.Data()
	if len(d) < 113 {
