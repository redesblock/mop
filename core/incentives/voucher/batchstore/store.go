...
type store struct {
	...
	batchExpiry         voucher.BatchExpiryHandler
	storageRadiusSetter voucher.StorageRadiusSetter // setter for radius notifications
}
...
func (s *store) SetStorageRadiusSetter(r voucher.StorageRadiusSetter) {
...
func (s *store) SetBatchExpiryHandler(be voucher.BatchExpiryHandler) {
	s.batchExpiry = be
}
