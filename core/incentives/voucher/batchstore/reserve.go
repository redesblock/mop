...
// the batch used in the voucher stamp attached to the chunk.
...
func (s *store) saveBatch(b *voucher.Batch) error {
...
// Unreserve is implementation of voucher.Storer interface Unreserve method.
func (s *store) Unreserve(cb voucher.UnreserveIteratorFn) error {
