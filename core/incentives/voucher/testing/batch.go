...
type BatchOption func(c *voucher.Batch)
...
func MustNewBatch(opts ...BatchOption) *voucher.Batch {
	b := &voucher.Batch{
		ID:          MustNewID(),
		Value:       NewBigInt(),
		Start:       rand.Uint64(),
...
func CompareBatches(t *testing.T, want, got *voucher.Batch) {
	t.Helper()
