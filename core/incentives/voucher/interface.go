...
// emitted by the voucher contract on the blockchain.
...
// ChainSnapshot represents the snapshot of all the voucher events between the
// FirstBlockNumber and LastBlockNumber. The timestamp stores the time at which the
// snapshot was generated. This snapshot can be used to chainsync the voucher package
