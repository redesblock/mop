...
type Service struct {
	...
	settlementSentFunc func(cluster.Address) (*big.Int, error)
	settlementRecvFunc func(cluster.Address) (*big.Int, error)
	...
	receiveChequeFunc   func(context.Context, cluster.Address, *chequebook.SignedCheque, *big.Int, *big.Int) error
	payFunc             func(context.Context, cluster.Address, *big.Int)
	handshakeFunc       func(cluster.Address, common.Address) error
...
func WithReceiveChequeFunc(f func(context.Context, cluster.Address, *chequebook.SignedCheque, *big.Int, *big.Int) error) Option {
	return optionFunc(func(s *Service) {
