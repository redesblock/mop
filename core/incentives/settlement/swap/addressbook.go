...
func (a *addressbook) MigratePeer(oldPeer, newPeer cluster.Address) error {
...
// Beneficiary returns the beneficiary for the given peer.
func (a *addressbook) Beneficiary(peer cluster.Address) (beneficiary common.Address, known bool, err error) {
...
// BeneficiaryPeer returns the peer for a beneficiary.
func (a *addressbook) BeneficiaryPeer(beneficiary common.Address) (peer cluster.Address, known bool, err error) {
	err = a.store.Get(beneficiaryPeerKey(beneficiary), &peer)
	if err != nil {
		if err != storage.ErrNotFound {
			return cluster.Address{}, false, err
		}
		return cluster.Address{}, false, nil
	}
	return peer, true, nil
}

// Chequebook returns the chequebook for the given peer.
func (a *addressbook) Chequebook(peer cluster.Address) (chequebookAddress common.Address, known bool, err error) {
...
// ChequebookPeer returns the peer for a beneficiary.
func (a *addressbook) ChequebookPeer(chequebook common.Address) (peer cluster.Address, known bool, err error) {
...
// PutBeneficiary stores the beneficiary for the given peer.
func (a *addressbook) PutBeneficiary(peer cluster.Address, beneficiary common.Address) error {
...
// PutChequebook stores the chequebook for the given peer.
func (a *addressbook) PutChequebook(peer cluster.Address, chequebook common.Address) error {
...
func (a *addressbook) AddDeductionFor(peer cluster.Address) error {
	return a.store.Put(peerDeductedForKey(peer), struct{}{})
}

func (a *addressbook) AddDeductionBy(peer cluster.Address) error {
	return a.store.Put(peerDeductedByKey(peer), struct{}{})
}

func (a *addressbook) GetDeductionFor(peer cluster.Address) (bool, error) {
	var nothing struct{}
...
func (a *addressbook) GetDeductionBy(peer cluster.Address) (bool, error) {
	var nothing struct{}
...
func peerKey(peer cluster.Address) string {
...
func peerBeneficiaryKey(peer cluster.Address) string {
...
func peerDeductedByKey(peer cluster.Address) string {
	return fmt.Sprintf("%s%s", deductedByPeerPrefix, peer.String())
}

func peerDeductedForKey(peer cluster.Address) string {
