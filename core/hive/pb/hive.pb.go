...
func (m *HopAddress) GetUnderlay() string {
	if m != nil {
		return m.Underlay
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*HopAddress)(nil), "pb.HopAddress")
}
...
var fileDescriptor_d635d1ead41ba02c = []byte{
	...
	0x8d, 0xf8, 0xf4, 0x0a, 0x92, 0xf4, 0x3c, 0xf2, 0x0b, 0x1c, 0x53, 0x52, 0x8a, 0x52, 0x8b, 0x8b,
	...
	0x00, 0x00, 0xff, 0xff, 0x46, 0x72, 0x91, 0xb8, 0xa5, 0x00, 0x00, 0x00,
}
