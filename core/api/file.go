...
// hopFileUploadHandler uploads the file and its metadata supplied as a multipart http message.
func (s *server) hopFileUploadHandler(w http.ResponseWriter, r *http.Request) {
...
// hopFileDownloadHandler downloads the file given the entry's reference.
func (s *server) hopFileDownloadHandler(w http.ResponseWriter, r *http.Request) {
