...
func TestConnect(t *testing.T) {
	underlay := "/ip4/127.0.0.1/tcp/1684/p2p/16Uiu2HAkx8ULY8cTXhdVAcMmLcH9AsTKz6uBQ7DPLKRjMLgBVYkS"
	errorUnderlay := "/ip4/127.0.0.1/tcp/1684/p2p/16Uiu2HAkw88cjH2orYrB6fDui4eUNdmgkwnDM8W681UbfsPgM9QY"
...
func TestDisconnect(t *testing.T) {
	address := cluster.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59c")
	unknownAddress := cluster.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59e")
	errorAddress := cluster.MustParseHexAddress("ca1e9f3938cc1425c6061b96ad9eb93e134dfe8734ad490164ef20af9d1cf59a")
	testErr := errors.New("test error")

	testServer, _, _, _ := newTestServer(t, testServerOptions{
		DebugAPI: true,
		P2P: mock.New(mock.WithDisconnectFunc(func(addr cluster.Address, reason string) error {
