...
func TestCORSHeaders(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			name:           "no origin",
			allowedOrigins: []string{"https://gateway.bnbflock.org"},
			wantCORS:       false,
		},
		{
			name:           "single explicit",
			origin:         "https://gateway.bnbflock.org",
			allowedOrigins: []string{"https://gateway.bnbflock.org"},
			wantCORS:       true,
		},
		{
		...
		},
		{
			...
			origin:         "https://staging.gateway.bnbflock.org",
			allowedOrigins: []string{"https://gateway.bnbflock.org", "https://staging.gateway.bnbflock.org"},
			wantCORS:       true,
		},
		{
