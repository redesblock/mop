...
const (
	httpErrGetAccountingInfo = "Cannot get bookkeeper info"
)
...
func (s *Service) accountingInfoHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		s.logger.Debug("bookkeeper info failed to load balances")
		s.logger.Error(err, "can not get bookkeeper info")
		return
	}
