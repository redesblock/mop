...
func TestSetWelcomeMessage(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			wantFail: true,
			message: `mmmbmbmbmbBmBBmbBbmbbbBmmmmBmBbmmBBBbBmBmmmbbBmBBmBBbmm
			
			bBbbmmbmmmbbBbmmbmmmmbmmmmbBmmmbmmmmmBmbmm`, // 513 characters
